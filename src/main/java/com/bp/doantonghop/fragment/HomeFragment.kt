...
import com.bp.doantonghop.model.User
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.ln_website.setOnClickListener{
            val url = "http://doantonghop.com"
            val i = Intent(Intent.ACTION_VIEW)
            i.data = Uri.parse(url)
            startActivity(i)
        }

        view.ln_owner.setOnClickListener{
            val dialog = Dialog(requireActivity())
            dialog.setContentView(R.layout.owner_detail_dialog)
