package com.bp.doantonghop.fragment
...
import com.bp.doantonghop.HomeActivity
import com.bp.doantonghop.MainActivity
import com.bp.doantonghop.MapUtils
import com.bp.doantonghop.R
import com.bp.doantonghop.model.*
import com.bp.doantonghop.services.APIUtils
import com.bp.doantonghop.services.DataClient
...
class MapFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        mBikeMaker = MapUtils().getMarkerIconFromDrawable(ContextCompat.getDrawable(requireContext(), R.drawable.garage_marker))
...
//    }
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        ...
        mMap.setOnMarkerClickListener { marker ->
            ...
            tv_brand_bt_sheet.text = mListBike[idMarker].phone
...
//                }
    ...
    private fun loadAllEBike() {
        ...
        val callback: Call<List<Ebike>> = dataClient.loadEBike1()
