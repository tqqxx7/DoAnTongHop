...
import com.bp.doantonghop.fragment.MapFragment
import com.bp.doantonghop.fragment.RatingFragment
...
class EBikeDetailActivity : AppCompatActivity(), MapFragment.OnMapFragmentListener, RatingFragment.OnRatingFragmentListener {
    ...
    private fun initView() {
        ...
        Glide.with(this).load(R.drawable.img_repair).into(ivDetail)
